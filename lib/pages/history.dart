...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    DataRow getDataRow(index, data) {
      return DataRow(
        cells: <DataCell>[
          (DataCell(Expanded(child: Text(data.name,  maxLines: 6,
  softWrap: true,)))),
          DataCell(Expanded(child: Text('£${data.cost.toStringAsFixed(2)}', maxLines: 2,
  softWrap: false,),)),
          DataCell(Expanded(child: Text(data.createdAt,maxLines: 2,
  softWrap: false,))),
          DataCell(
